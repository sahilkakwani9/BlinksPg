//This code has been taken from solana-labs explorer codebase
//Reference: https://github.com/solana-labs/explorer/blob/master/app/utils/token-info.ts
